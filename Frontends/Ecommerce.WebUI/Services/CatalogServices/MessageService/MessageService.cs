...
namespace Ecommerce.WebUI.Services.CatalogServices.MessageService
{
    public class MessageService : IMessageService
    {
        ...
        {
            var responseMessage = await _httpClient.GetAsync("http://localhost:5085/services/Message/UserMessage/GetMessageInbox?id=" + id);
        ...
        {
            var responseMessage = await _httpClient.GetAsync("http://localhost:5085/services/Message/UserMessage/GetMessageSendbox?id=" + id);
